...
(cl:in-package altitude_controller-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Error>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Error)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name altitude_controller-msg:<Error> is deprecated: use altitude_controller-msg:Error instead.")))

(cl:ensure-generic-function 'errorX-val :lambda-list '(m))
(cl:defmethod errorX-val ((m <Error>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader altitude_controller-msg:errorX-val is deprecated.  Use altitude_controller-msg:errorX instead.")
  (errorX m))

(cl:ensure-generic-function 'errorY-val :lambda-list '(m))
(cl:defmethod errorY-val ((m <Error>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader altitude_controller-msg:errorY-val is deprecated.  Use altitude_controller-msg:errorY instead.")
  (errorY m))

(cl:ensure-generic-function 'errorT-val :lambda-list '(m))
(cl:defmethod errorT-val ((m <Error>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader altitude_controller-msg:errorT-val is deprecated.  Use altitude_controller-msg:errorT instead.")
  (errorT m))

(cl:ensure-generic-function 'errorZ-val :lambda-list '(m))
(cl:defmethod errorZ-val ((m <Error>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader altitude_controller-msg:errorZ-val is deprecated.  Use altitude_controller-msg:errorZ instead.")
  (errorZ m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Error>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'errorT))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'errorZ))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Error>)))
  ...
  (cl:format cl:nil "float32 errorX~%float32 errorY~%float32 errorT~%float32 errorZ~%~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Error)))
  "Returns full string definition for message of type 'Error"
  (cl:format cl:nil "float32 errorX~%float32 errorY~%float32 errorT~%float32 errorZ~%~%~%~%~%"))
