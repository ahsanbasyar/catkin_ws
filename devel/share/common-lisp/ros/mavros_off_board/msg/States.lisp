...
(cl:defmethod cl:initialize-instance :after ((m <States>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'States)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros_off_board-msg:<States> is deprecated: use mavros_off_board-msg:States instead.")))

(cl:ensure-generic-function 'Xc-val :lambda-list '(m))
(cl:defmethod Xc-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros_off_board-msg:Xc-val is deprecated.  Use mavros_off_board-msg:Xc instead.")
  (Xc m))

(cl:ensure-generic-function 'Yc-val :lambda-list '(m))
(cl:defmethod Yc-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros_off_board-msg:Yc-val is deprecated.  Use mavros_off_board-msg:Yc instead.")
  (Yc m))

(cl:ensure-generic-function 'W-val :lambda-list '(m))
(cl:defmethod W-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros_off_board-msg:W-val is deprecated.  Use mavros_off_board-msg:W instead.")
  (W m))

(cl:ensure-generic-function 'H-val :lambda-list '(m))
(cl:defmethod H-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros_off_board-msg:H-val is deprecated.  Use mavros_off_board-msg:H instead.")
  (H m))

(cl:ensure-generic-function 'Theta-val :lambda-list '(m))
(cl:defmethod Theta-val ((m <States>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros_off_board-msg:Theta-val is deprecated.  Use mavros_off_board-msg:Theta instead.")
  (Theta m))
