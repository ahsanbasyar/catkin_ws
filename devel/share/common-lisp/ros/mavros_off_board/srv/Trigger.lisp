...
(cl:in-package mavros_off_board-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Trigger-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Trigger-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros_off_board-srv:<Trigger-request> is deprecated: use mavros_off_board-srv:Trigger-request instead.")))

(cl:ensure-generic-function 'trigger-val :lambda-list '(m))
(cl:defmethod trigger-val ((m <Trigger-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros_off_board-srv:trigger-val is deprecated.  Use mavros_off_board-srv:trigger instead.")
  (trigger m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Trigger-request>)))
  ...
  "mavros_off_board/TriggerRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Trigger-request)))
  "Returns string type for a service object of type 'Trigger-request"
  "mavros_off_board/TriggerRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Trigger-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Trigger-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros_off_board-srv:<Trigger-response> is deprecated: use mavros_off_board-srv:Trigger-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <Trigger-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros_off_board-srv:success-val is deprecated.  Use mavros_off_board-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <Trigger-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros_off_board-srv:message-val is deprecated.  Use mavros_off_board-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Trigger-response>)))
  ...
  "mavros_off_board/TriggerResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Trigger-response)))
  "Returns string type for a service object of type 'Trigger-response"
  "mavros_off_board/TriggerResponse")
