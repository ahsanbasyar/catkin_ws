...
def waypoint():
    package = 'mavros_off_board'
    launch_file = 'singledroneCallSoft.launch'
...
def startCamera():
    ...
    try:
        process = subprocess.Popen(['roslaunch', package, launch_file], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
